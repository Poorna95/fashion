...
exports.urlScrapper = async (
  ...
  try {
    ...
    await page.waitForSelector("#loginForm > div > div:nth-child(1) > div > label > input", { timeout: 3000 });
    await page.type("#loginForm > div > div:nth-child(1) > div > label > input", fb_email);
    await page.type("#loginForm > div > div:nth-child(2) > div > label > input", fb_pass);
